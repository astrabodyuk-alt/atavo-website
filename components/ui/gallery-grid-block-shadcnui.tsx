...
const galleryImages = [
  ...
  {
    id: 2,
    url: "/images/777_1x_shots_so.png",
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-muted-foreground">
            A showcase of websites, apps and digital experiences we&apos;ve built for UK businesses.
          </p>
        </motion.div>
                ...
                >
                  <div className="relative aspect-square overflow-hidden">
                    ...
                    >
                      ...
                      {image.location && (
                        <p className="mb-1 text-xs text-white/60">{image.location}</p>
                      )}
              ...
              >
                ...
                >
                  ...
                  {selectedImageData.location && (
                    <p className="mb-2 text-sm text-white/50">{selectedImageData.location}</p>
                  )}
